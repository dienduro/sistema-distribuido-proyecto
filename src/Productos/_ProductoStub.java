...
public class _ProductoStub extends org.omg.CORBA.portable.ObjectImpl implements Productos.Producto
{
  ...
  public boolean insertarProducto (String nombre, String modelo, String marca, float precio_compra, float precio_venta)
  {
            ...
            try {
                ...
                $out.write_wstring (modelo);
                $out.write_wstring (marca);
                $out.write_float (precio_compra);
                $out.write_float (precio_venta);
                $in = _invoke ($out);
                ...
                return insertarProducto (nombre, modelo, marca, precio_compra, precio_venta        );
            } finally {
                _releaseReply ($in);
            }
  } // insertarProducto
  ...
  public boolean actualizarProducto (int id_prod, String nombre, String modelo, String marca, float precio_compra, float precio_venta)
  {
            ...
            try {
                ...
                return actualizarProducto (id_prod, nombre, modelo, marca, precio_compra, precio_venta        );
            } finally {
                _releaseReply ($in);
            }
  } // actualizarProducto
  ...
  public boolean eliminarProducto (int id_prod)
  {
            ...
            try {
                ...
                return eliminarProducto (id_prod        );
            } finally {
                _releaseReply ($in);
            }
  } // eliminarProducto
  ...
  public String consultarProducto (int id_prod)
  {
            ...
            try {
                ...
                return consultarProducto (id_prod        );
            } finally {
                _releaseReply ($in);
            }
  } // consultarProducto
