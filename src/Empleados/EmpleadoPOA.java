                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // Empleados/Empleado/insertarEmpleado
       {
         ...
         String hora_entrada = in.read_wstring ();
         ...
         $result = this.insertarEmpleado (cedula_empleado, nombre, apellido, genero, direccion, fecha_nacimiento, estado_civil, codigo_cargo, hora_entrada, hora_salida, telefono, sueldo, empresa_ruc);
         out = $rh.createReply();
       ...
       case 2:  // Empleados/Empleado/eliminarEmpleado
       {
         int cedula_empleado = in.read_long ();
         boolean $result = false;
         $result = this.eliminarEmpleado (cedula_empleado);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
       ...
       case 3:  // Empleados/Empleado/consultarEmpleado
       {
         int cedula_empleado = in.read_long ();
         String $result = null;
         $result = this.consultarEmpleado (cedula_empleado);
         out = $rh.createReply();
